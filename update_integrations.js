...
export function IntegrationsSection() {
  const orbitingIcons = [
    ...
    { Icon: FaWallet, color: "text-orange-500", top: "50%", left: "90%", delay: "5s" }, // Cashfree
    { Icon: MdStorefront, color: "text-blue-600", top: "85%", left: "50%", delay: "6s" }, // Google Merchant
  ];
          ...
          <div className="relative w-full aspect-square max-w-[500px] mx-auto lg:mx-0 lg:ml-auto">
            ...
            {orbitingIcons.map((item, idx) => {
              ...
              return (
                ...
                >
                  <Icon className={\`w-6 h-6 sm:w-8 sm:h-8 \${color}\`} strokeWidth={0} />
                </div>
              );
            })}
          </div>
