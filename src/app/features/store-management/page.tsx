              ...
              <div className="rounded-[1.5rem] bg-white p-5 text-gray-900">
                <div className="flex items-center justify-between border-b border-gray-100 pb-4">
                  ...
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-purple-100 text-purple-700">
                    <LandingIcon name="shopping-bag" size={22} />
                  </div>
                </div>
                ...
                <div className="mt-5 grid gap-3">
                  <div className="flex items-center gap-3 rounded-xl bg-gray-50 p-3">
                    ...
                    <span className="text-sm font-semibold text-gray-700">Order status tracking</span>
                  </div>
                  <div className="flex items-center gap-3 rounded-xl bg-gray-50 p-3">
                    <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-purple-100 text-purple-700">
                      <LandingIcon name="sparkles" size={15} />
                    </div>
                    <span className="text-sm font-semibold text-gray-700">Customer timelines</span>
                  </div>
                  <div className="flex items-center gap-3 rounded-xl bg-gray-50 p-3">
                    <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-purple-100 text-purple-700">
                      <LandingIcon name="sparkles" size={15} />
                    </div>
                    <span className="text-sm font-semibold text-gray-700">Team-ready admin tools</span>
                  </div>
                </div>

                <div className="mt-5 grid grid-cols-3 gap-3">
                  <div className="rounded-xl border border-gray-100 bg-white p-3 text-center shadow-sm">
                    <div className="text-lg font-bold text-gray-950">1</div>
                    <div className="mt-1 text-[11px] font-semibold uppercase tracking-wide text-gray-500">store hub</div>
                  </div>
                  <div className="rounded-xl border border-gray-100 bg-white p-3 text-center shadow-sm">
                    <div className="text-lg font-bold text-gray-950">24/7</div>
                    <div className="mt-1 text-[11px] font-semibold uppercase tracking-wide text-gray-500">order visibility</div>
                  </div>
                  <div className="rounded-xl border border-gray-100 bg-white p-3 text-center shadow-sm">
                    <div className="text-lg font-bold text-gray-950">5x</div>
                    <div className="mt-1 text-[11px] font-semibold uppercase tracking-wide text-gray-500">faster updates</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="px-4 py-18 sm:px-6 lg:px-8 md:py-24">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-12 grid gap-5 md:grid-cols-3">
              <div className="reveal reveal-delay-1 rounded-2xl border border-gray-200 bg-white p-6 shadow-[0_18px_45px_-32px_rgba(15,23,42,0.55)]">
                <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-xl bg-purple-100 text-purple-700">
                  <LandingIcon name="rocket" size={22} />
                </div>
              ...
              <div className="reveal reveal-delay-2 rounded-2xl border border-gray-200 bg-white p-6 shadow-[0_18px_45px_-32px_rgba(15,23,42,0.55)]">
                <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-xl bg-purple-100 text-purple-700">
                  <LandingIcon name="bar-chart" size={22} />
                </div>
        ...
        <section className="px-4 pb-28 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl overflow-hidden rounded-3xl bg-gray-900 p-8 text-center text-white shadow-[0_20px_60px_-15px_rgba(124,58,237,0.28)] sm:p-10 md:p-14">
            ...
            <h2 className="reveal reveal-delay-1 mt-4 text-3xl font-bold tracking-tight sm:text-4xl">
              Bring Store Management into your commerce stack
            </h2>
