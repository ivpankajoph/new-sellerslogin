...
export const metadata: Metadata = { title: "Ecommerce | Sellers Login", description: "Ecommerce storefront, order, analytics, and automation tools." };
...
const page: OptionPageContent = {
  ...
  description: "Ecommerce teams can build storefronts, manage orders, track performance, automate growth, and scale operations from Sellers Login.",
