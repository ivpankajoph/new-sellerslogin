...
export const metadata: Metadata = { title: "Manufacturing | SellersLogin", description: "Commerce tools for manufacturing catalogs, dealers, and inventory workflows." };
...
const page: OptionPageContent = {
  ...
  description: "Manufacturing teams can manage dealer catalogs, bulk orders, inventory visibility, and account-led selling with SellersLogin.",
