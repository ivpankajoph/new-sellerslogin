...
export const metadata: Metadata = { title: "Real estate | SellersLogin", description: "Lead capture and digital workflows for real estate teams." };
...
const page: OptionPageContent = {
  ...
  description: "Real estate teams can publish project pages, capture inquiries, route leads, and keep broker activity visible in SellersLogin.",
