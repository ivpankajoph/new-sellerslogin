            ...
            return (
              <div key={i} className="reveal">
                ...
                >
                  <button
                    type="button"
                    className={`w-full p-5 md:p-6 flex items-center justify-between text-left text-base md:text-lg font-semibold transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 cursor-pointer ${
                      isOpen ? "bg-violet-50 text-violet-900" : "text-gray-900 hover:bg-gray-50/50"
                    }`}
                    onClick={() => toggleFAQ(i)}
